    ...
    switch(category) {
        case 'phones':
            products.phones.forEach(function(phone) {
                prod.insertAdjacentHTML('afterbegin', getProductMarkup(phone));
            })
        break;
        case 'tv':
            products.tv.forEach(function(onetv) {
                prod.insertAdjacentHTML('afterbegin', getProductMarkup(onetv));
            })
        break;
        case 'tablets':
            products.tablets.forEach(function(tablet) {
                prod.insertAdjacentHTML('afterbegin', getProductMarkup(tablet));
            })
        break;
    }
}
